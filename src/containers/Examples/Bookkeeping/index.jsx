...
export default function Bookkeeping() {
   return (
      <div className="quoteCanvas-bg">
         <div className="container qCustomCss quoteCanvas quoteCanvas-2col">
            <div className="quoteCanvas-page">
               <div className="row">
                  <div className="col-sm-9">
                     <h1 className="quoteCanvas-title">
                        Comprehensive monthly bookkeeping </h1>
                     ...
                     <div className="quoteItems" data-tg-control="QuoteViewTotal">
                        ...
                        <div className="tItem vIsLine tItemId-3 isSelected">
                           <div className="tItem-desc">
                              <div className="tItem-desc-table">
                                 <div className="tItem-desc-option">
                                    ...
                                    <input className="choiceInput choiceInput-radio" type="radio" name="choiceGroup[0]" id="choiceId-3" defaultValue={1} defaultChecked="checked" />
                                 </div>
                                 <div className="tItem-desc-cell">
                                    <h3><a data-tg-click="clickOptionTitle" href="javascript:void(0)">Pro Package</a></h3>
                                    <p>Our most comprehensive, robust package, offering intuitive
                                    services that cater to all aspects of your business. This
                                    ...
                                    <ul>
                                       ...
                                       <li>Cash flow forecasts and budget monitoring</li>
                                       <li>Accounts payable and receivable</li>
                                       <li>Paperwork filing</li>
                                       <li>Payroll calculation (either weekly or fortnightly)</li>
                                       <li>Wage payments </li>
                           ...
                           <div className="tItem-price">
                              <p>
                                 <span className="itemPartItemTotal">1,200.00</span>
                              </p>
                              <p className="quote-text-sm"><span className="option-text" /></p>
                           </div>
                           <div className="clear"> </div>
                        </div>
                        <div className="tItem vIsLine tItemId-4">
                           <div className="tItem-desc">
                              <div className="tItem-desc-table">
                                 <div className="tItem-desc-option">
                                    <input className="jsContactSelected" name="viewItem[4][contact_selected]" defaultValue={2} type="hidden" id="viewItem_4_contact_selected" /><label htmlFor="choiceId-4" className="isHidden" aria-hidden="true" />
                                    <input className="choiceInput choiceInput-radio" type="radio" name="choiceGroup[0]" id="choiceId-4" defaultValue={1} />
                                 </div>
                                 <div className="tItem-desc-cell">
                        ...
                        <div className="tItem vIsLine tItemId-5">
                           <div className="tItem-desc">
                              <div className="tItem-desc-table">
                                 <div className="tItem-desc-option">
                                    <input className="jsContactSelected" name="viewItem[5][contact_selected]" defaultValue={2} type="hidden" id="viewItem_5_contact_selected" /><label htmlFor="choiceId-5" className="isHidden" aria-hidden="true" />
                                    <input className="choiceInput choiceInput-radio" type="radio" name="choiceGroup[0]" id="choiceId-5" defaultValue={1} />
                                 </div>
                                 <div className="tItem-desc-cell">
                           ...
                           <div className="tItem-price">
                              <p>
                                 <span className="itemPartItemTotal">200.00</span>
                              </p>
                              <p className="quote-text-sm"><span className="option-text">Not selected</span></p>
                           </div>
                           <div className="clear"> </div>
                           ...
                           <table className="quoteTotal subscribe_zFixedCost hasNoTerm">
                              <tbody><tr className="options">
                                 ...
                                 <td className="total-price">
                                    <p className="quote-text-sm">1 of 3</p>
                                 </td>
                              </tr>
                                 <tr className="total">
                                    <td className="total-desc">
                                    ...
                                    <td className="total-price">
                                       <p className="quoteTotal-gTotal">$1,200.00</p>
                                    </td>
                                 </tr>
                              </tbody></table>
                        </div>
                        ...
                        <div className="tItem-text tItemId-9">
                           <h3>The Bean Bookkeeping: 30 years of excellence</h3>
                     ...
                     <div id="discussion" className="discuss-wrap">
                        ...
                        <div className="no_print u-section-2">
                              ...
                              <div className="discuss-bubble">
                                 ...
                                 <div className="bubble-right">
                                    <div className="bubble-margin">
                                       <textarea className="form-control" rows={3} name="postDiscuss[discussIsQuestion][discuss_body]" id="postDiscuss_discussIsQuestion_discuss_body" defaultValue={""} />
                                    </div>
                           ...
                           <div className="discussIsEdit isHidden">
                              <input className="discuss-form-prefix" name="postDiscuss[discussIsEdit][_prefix]" defaultValue="discussIsEdit" type="hidden" id="postDiscuss_discussIsEdit__prefix" /> <input className="discuss-update-id" name="postDiscuss[discussIsEdit][_discuss_update_id]" defaultValue type="hidden" id="postDiscuss_discussIsEdit__discuss_update_id" />
                              <div className="bubble-margin">
                        ...
                        <div>
                           <div className="quote-review">
                              <div className="quote-review-stars">
                                 <img className="review-stars-small" src="https://asset.quotientapp.com/file-1/review-stars/25B3FA/5" alt="Quotient" />
                              </div>
                     ...
                     <div className="acceptBox no_print" data-tg-click="clickExampleIgnore" data-tg-focus="clickExampleIgnore">
                        <h3 className="quote-box-h3-accept">Comprehensive monthly bookkeeping</h3>
                        <div className="acceptSummary">
                           <p className="summaryWrapzFixedCost">
                              Total $<span className="summaryPartTotal">1,200.00</span> (<span className="summaryPartOption">1 of 3</span> options selected) </p>
                        </div>
                  ...
                  <div className="col-sm-3 quote-detail quote-detail-2col">
                     <div className="quote-detail-sm-pad">
                        <div className="quote-logo quote-logo-x-legacy  quote-logo-x-legacy-top">
                           <img title="The Bean Bookkeeping" alt="The Bean Bookkeeping" src="https://asset.quotientapp.com/image/quote-example/logo/logo-bookkeeping.png" />
                        </div>
