...
export const TemplateSettings = (props) => {
   ...
   return (
      <>
         ...
         <div className={`mb-3 ${show ? "" : "d-none"}`}>
            <div className="py-2">
               <label for="quantity" class="text-gray fa-xs text-uppercase">DISCOUNT %</label>
               <input type="text" id="quantity" class="form-control rounded-0 maxWidth-180" />
            </div>
            <div className="py-2">
               <label for="quantity" class="text-gray fa-xs text-uppercase">CURRENCY</label>
            ...
            <div className="py-2">
               <label for="quantity" class="text-gray fa-xs text-uppercase">AMOUNTS ARE</label>
               <select className="custom-select rounded-0">
            ...
            <div className="py-2">
               <label for="quantity" class="text-gray fa-xs text-uppercase">PRICING DISPLAY LEVEL</label>
         ...
         <button type="button" className="btn btn-outline-dark" onClick={() => setShow(!show)}>{show ? "Hide" : "Show All..."}</button>
